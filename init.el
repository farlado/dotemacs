...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (exwm-randr dmenu exwm spaceline dash dashboard rainbow-delimiters hungry-delete smart-hungry-delete switch-window rainbow-mode avy smex ido-vertical-mode spacemacs-theme which-key))))
(custom-set-faces
