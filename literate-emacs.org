...
At first I questioned why I would do this, but now that I know the advantages of this, it's too good to pass up. This allows me to edit text from an X window using Emacs by pressing =C-c '= in spite of some window splitting issues the package has...
#+BEGIN_SRC emacs-lisp
