...
Because I now use so many workspaces, I need to be able to see what workspace I am currently on. This makes it easier to do that. I also forcibly get rid of the dumb startup message so workspace labels immediately are visible.
#+BEGIN_SRC emacs-lisp
