...
-- [[https://lists.gnu.org/archive/html/emacs-devel/2020-01/msg00127.html][Richard M. Stallman]]
#+end_quote
...
- [[#giving-files-headers][Giving files headers]]
- [[#making-emacs-start-quickly-and-smoothly][Making Emacs start quickly and smoothly]]
  - [[#do-these-asap][Do these ASAP]]
  - [[#package-management][Package management]]
  - [[#after-package-management][After package management]]
- [[#making-emacs-significantly-less-ugly][Making Emacs significantly less ugly]]
  - [[#font][Font]]
  - [[#theme][Theme]]
  - [[#mode-line][Mode line]]
...
- [[#making-emacs-organizeplay-music][Making Emacs organize/play music]]
...
- [[#making-emacs-a-good-text-editor][Making Emacs a good text editor]]
  ...
  - [[#org-mode][~org-mode~]]
- [[#making-emacs-e-x-t-e-n-d][Making Emacs =e x t e n d=]]
  - [[#built-in-features][Built-in features]]
  - [[#not-built-in][Not built-in]]
  - [[#games][Games]]
- [[#giving-files-footers][Giving files footers]]
#+END_QUOTE
...
** Do these ASAP
   ...
   :end:
Either I want these configured as soon as possible, or they are related to Emacs starting up. Which are which is left as an exercise to the reader. Regardless, all of this is placed in ~early-init.el~ for the sake of speed.

*** Hide dumb stuff (Part 1)
...
** Package management
   ...
   :header-args: :tangle (expand-file-name "early-init.el" user-emacs-directory)
   :end:
   Because I am writing this configuration to be as portable as possible (e.g. I should be able to dump this onto any machine and run it), I manage all packages through Emacs. All of this also is run in ~early-init.el~ leading up to the call of ~package-initialize~ between that file and ~init.el~, which probably will make for faster loading.
...
*** Fringes
Having fringes helps keep things looking good and gives the opportunity to have nice indicators on the edges of buffers.
#+begin_src emacs-lisp
  (fringe-mode 10)
#+end_src
