...
*** Global binds to use across everything
    ...
    Anything I couldn't cram into ~desktop-environment-mode~ has been slapped into
    this area. Since I'm very lazy and don't feel like writing a whole bunch of
    lambdas for multiple workspaces, presented here are instead some ~mapcar~
    calls, like the one in [[https://github.com/ch11ng/exwm/wiki/Configuration-Example][this example]].
