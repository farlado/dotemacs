...
Not the best way to do epub reading, but at least it's in Emacs. It is currently disabled because it broke ~org-mode~.
...
It's [[https://github.com/farlado/emacs-xkb][its own package]] now.
#+begin_src emacs-lisp
  (use-package xkb
    :load-path "lisp/xkb"
    :defer t
