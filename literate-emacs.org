...
Any good desktop environment allows you to set a wallpaper. I have a [[https://github.com/farlado/wallpapers][wallpaper repository]] which I keep in =$XDG_CONFIG_HOME/wallpapers= from which random wallpapers are chosen for each monitor.
#+begin_src emacs-lisp
...
However, I want to go even further: I want to /have my wallpapers as a slideshow/.
#+begin_src emacs-lisp
