...
** Keybindings
   ...
   applicationes are all placed in one area to make it easier to manage them.
...
*** Emacs key bindings in X windows
    ...
    functions which are called in order to provide the desired behavior.  This
    ensures that keys I use in Emacs behave similarly in X windows as they do in
    Emacs itself.
