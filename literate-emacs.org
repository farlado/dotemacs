...
- [[#giving-initel-a-header][Giving ~init.el~ a header]]
...
- [[#making-emacs-e-x-t-e-n-d][Making Emacs =e x t e n d=]]
  ...
  - [[#games][Games]]
- [[#giving-initel-a-footer][Giving ~init.el~ a footer]]
#+END_QUOTE
...
** About this branch
With each new major version of Emacs, I will be making many massive changes to this configuration. Rather than try to manage keeping a single configuration with compatibility for every version of Emacs since the very beginning of the configuration's existence, I will instead branch when moving between major versions. The branches for the end of each major version will only be altered if issues and pull requests are made.
