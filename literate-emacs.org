...
Next we need to determine what size to make the text. I originally used an ~xrandr~ script here, but it was taking a surprising amount of time.
#+begin_src emacs-lisp
...
*** Hide coding system from mode line in EXWM
