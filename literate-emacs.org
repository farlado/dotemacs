...
*** Fringes
Having fringes also helps keep things looking good. However, I really do not want the fringes to have a color that is different from the default background.
#+BEGIN_SRC emacs-lisp
...
I like having line numbers and indicators for lines past the EOF. I also like having the current line highlighted. However, I don't like line numbers in modes where it breaks the mode, and I want line numbers to look consistent.
#+BEGIN_SRC emacs-lisp
