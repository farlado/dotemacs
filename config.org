...
#+BEGIN_SRC emacs-lisp
  (setq exwm-workspace-number 3
        ...
        exwm-randr-workspace-output-plist '(0 "LVDS1"
                                            ...
                                            1 "DP-1-2-1"
                                            2 "DP-1-2-3")
        exwm-manage-configurations '(((eq exwm-class-name "Steam")
                                      workspace 0 floating t floating-mode-line nil)
                                     ((eq exwm-instance-name "telegram-desktop")
                                      workspace 2)
                                     ((eq exwm-class-name "discord")
                                      workspace 1)
                                     ((eq exwm-title "Event Tester")
                                      floating t)))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (dolist (hook '(nov-mode-hook tetris-mode-hook snake-mode-hook sudoku-mode-hook
                  ...
                  shell-mode-hook Man-mode-hook epresent-mode-hook custom-mode-hook))
