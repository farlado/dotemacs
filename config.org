...
#+END_SRC
** Set keymap to US and give capslock the functionality of control
...
#+BEGIN_SRC emacs-lisp
  ...
  (global-set-key (kbd "s-SPC") 'cycle-keyboard-layout)
  (define-key exwm-mode-map (kbd "s-SPC") 'cycle-keyboard-layout)

  (global-set-key (kbd "<s-backspace>") 'cycle-keyboard-layout-reverse)
  (define-key exwm-mode-map (kbd "<s-backspace>") 'cycle-keyboard-layout-reverse)
#+END_SRC
** Suspending
#+BEGIN_SRC emacs-lisp
