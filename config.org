...
#+BEGIN_SRC emacs-lisp
  ...
  (define-key desktop-environment-mode-map (kbd "s-n") 'network-settings)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (define-key desktop-environment-mode-map
    (kbd "s-SPC") 'cycle-keyboard-layout)

  (define-key desktop-environment-mode-map
    (kbd "<s-backspace>") 'cycle-keyboard-layout-reverse)
#+END_SRC
** Suspending
#+BEGIN_SRC emacs-lisp
...
#+BEGIN_SRC emacs-lisp
  ...
  (define-key desktop-environment-mode-map (kbd "s-a x") 'mpd/start-music-daemon)
#+END_SRC
*** Stopping the daemon
#+BEGIN_SRC emacs-lisp
  ...
  (define-key desktop-environment-mode-map (kbd "s-a q") 'mpd/kill-music-daemon)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (define-key desktop-environment-mode-map (kbd "s-a r d") 'mpd/update-database)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (define-key desktop-environment-mode-map (kbd "s-a a") 'mpc-status)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (define-key desktop-environment-mode-map (kbd "s-a s") 'emms-shuffle-message)
#+END_SRC
*** Setting repeat mode
#+BEGIN_SRC emacs-lisp
  (define-key desktop-environment-mode-map (kbd "s-a r a") 'emms-toggle-repeat-playlist)
  (define-key desktop-environment-mode-map (kbd "s-a r t") 'emms-toggle-repeat-track)
#+END_SRC
* Other programs
...
#+BEGIN_SRC emacs-lisp
  ...
  (define-key desktop-environment-mode-map (kbd "<XF86Calculator>") 'calc)
...
#+BEGIN_SRC emacs-lisp
  ...
  (define-key desktop-environment-mode-map (kbd "s-f") 'run-firefox)
#+END_SRC
*** LibreOffice
...
#+BEGIN_SRC emacs-lisp
  ...
  (define-key desktop-environment-mode-map (kbd "s-b") 'run-libreoffice)
#+END_SRC
*** GIMP
...
#+BEGIN_SRC emacs-lisp
  ...
  (define-key desktop-environment-mode-map (kbd "s-g") 'run-gimp)
#+END_SRC
*** Telegram
...
#+BEGIN_SRC emacs-lisp
  ...
  (define-key desktop-environment-mode-map (kbd "s-t") 'run-tg)
#+END_SRC
*** Discord
...
#+BEGIN_SRC emacs-lisp
  ...
  (define-key desktop-environment-mode-map (kbd "s-d") 'run-discord)
#+END_SRC
*** Steam
...
#+BEGIN_SRC emacs-lisp
  ...
  (define-key desktop-environment-mode-map (kbd "s-s") 'run-steam)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (add-hook 'flyspell-mode-hook '(lambda () (flyspell-buffer)))
...
#+BEGIN_SRC emacs-lisp
  (define-key desktop-environment-mode-map (kbd "C-s-w") 'windmove-up)
  (define-key desktop-environment-mode-map (kbd "C-s-a") 'windmove-left)
  (define-key desktop-environment-mode-map (kbd "C-s-s") 'windmove-down)
  (define-key desktop-environment-mode-map (kbd "C-s-d") 'windmove-right)
