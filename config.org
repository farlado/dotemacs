...
* Startup
** Hide things ASAP
I hate having to look at these every time my system starts up. Who even uses the toolbar in Emacs?
...
#+BEGIN_SRC emacs-lisp
  (use-package system-packages
    ...
    :bind (("C-c p i"   . system-packages-install)
	   ...
	   ("C-c p C-r" . system-packages-remove-orphans)
...
No clue why you have to do so much just to give workspaces names, but at least you can do it. I also put which monitors to try to put workspaces onto here.
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
*** Multi-head
I have been trying to make this into an elisp function, but for now I'm still stuck with a shell script.
#+BEGIN_SRC emacs-lisp
  (add-hook 'exwm-randr-screen-change-hook
	    (lambda ()
	      (start-process-shell-command
	       "Display Setup" nil "ds")))
  (exwm-randr-enable)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (use-package wttrin
	...
	(unwind-protect
	    (progn (wttrin wttrin-default-city)
