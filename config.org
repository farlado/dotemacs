...
Since this thing is changing daily, I really like having it available on a shortcut.
#+BEGIN_SRC emacs-lisp
  (defun config-visit ()
    (interactive)
...
I just wanna have words wrap around, honestly.
#+BEGIN_SRC emacs-lisp
...
Most of these functions use commands from [[https://gitlab.com/farlado/dotfiles][my dotfiles]] to complete various tasks.
**** Volume control
#+BEGIN_SRC emacs-lisp
  (defun volume-mute ()
    (interactive)
...
Again, this uses stuff from my dotfiles. Link is above.
#+BEGIN_SRC emacs-lisp
...
* General Looks
** Theme
I used to hate light themes. I'm not in that camp anymore. God I love this theme.
#+BEGIN_SRC emacs-lisp
...
#+BEGIN_SRC emacs-lisp
  (use-package pretty-mode
    ...
    (pretty-activate-groups
     '(:ordering :equality :logic :sets :sub-and-superscripts :function
		 :greek :punctuation :types :arrows :quantifiers :nil
		 :arithmetic :undefined :parentheses :other)))
#+END_SRC
...
Since I use EXWM, X windows will remove the thin divider which is present by default. To remedy this, I use a different method. I set it to a solid color.
#+BEGIN_SRC emacs-lisp
